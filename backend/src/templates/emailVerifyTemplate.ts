export const EMAIL_VERIFY_TEMPLATE: string = `
<!DOCTYPE html>
...
<body>
  <table class="container" role="presentation" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
      <td class="content">
        <p>Hi there,</p>
        <p>You are just one step away from verifying your account for this email: 
          <span class="highlight">{{email}}</span>.
        </p>
        <p>Please use the OTP code below to complete your verification:</p>
        <p class="otp-box" aria-label="Verification Code">{{otp}}</p>
